...
function inject(bot, {version}) {
    ...
    bot.customVelocityActivateChance = 1
    bot.customHorizontalVelocity = 1
    ...
    bot._client.on('entity_velocity', (packet) => {
        // entity velocity
        const entity = fetchEntity(packet.entityId)
        let notchVel = new Vec3(packet.velocityX, packet.velocityY, packet.velocityZ)
        if (Math.random() < bot.customVelocityActivateChance && packet.entityId === bot.entity.id) {
            notchVel = new Vec3(packet.velocityX * bot.customHorizontalVelocity, packet.velocityY, packet.velocityZ * bot.customHorizontalVelocity)
        } 
        entity.velocity.update(conv.fromNotchVelocity(notchVel))
    })
